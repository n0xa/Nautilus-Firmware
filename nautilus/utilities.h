...
// SGHZ
#define BOARD_SGHZ_CS   12
#define BOARD_SGHZ_SCK  BOARD_SPI_SCK
#define BOARD_SGHZ_MOSI BOARD_SPI_MOSI
#define BOARD_SGHZ_MISO BOARD_SPI_MISO
#define BOARD_SGHZ_IO2  38
#define BOARD_SGHZ_IO0  3
#define BOARD_SGHZ_SW1  47
#define BOARD_SGHZ_SW0  48
