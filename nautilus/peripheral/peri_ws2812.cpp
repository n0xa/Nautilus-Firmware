...
// Default mode 0 (static) - actual mode will be set by config_load() -> ui_scr1_set_mode()
...
void ws2812_init(void)
{
    ...
    FastLED.setBrightness(0);  // Start completely dark
    ws2812_set_color(CRGB::Black);  // LEDs off by default
    FastLED.show();
}
